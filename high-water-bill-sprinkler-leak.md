...
1.  **Soggy or Unusually Green Patches in Your Lawn:**
    If you have a spot in your yard that is constantly damp, spongy, or noticeably greener and lusher than the surrounding areas, it is a classic sign of an underground leak. A slow, steady leak in a lateral line will continuously water that specific area, creating a pocket of oversaturation.

2.  **Loss of Water Pressure in Your Sprinkler System:**
    Do your sprinkler heads seem to be spraying with less force than they used to? Does one zone, in particular, have heads that just bubble or barely pop up? A leak in the line creates a point of pressure loss, robbing the rest of the zone of the force needed to operate effectively. Your lawn will start to show dry, stressed spots as a result.

3.  **Water Running from a Sprinkler Head Long After the Zone is Off:**
    This is often referred to as a “weeping” valve. If you notice a single sprinkler head (usually the lowest one in a zone) trickling water for hours or even days after the system has run, it means the zone valve is not closing completely. This constant, low-volume flow is a major source of water waste.

4.  **Your Water Meter is Always Spinning:**
...
<script type="application/ld+json">
{
  ...
  "@type": "Service",
  "serviceType": "High Water Bill Diagnosis",
  "name": "High Water Bill Sprinkler Leak Diagnosis",
  "provider": {
    "@type": "LocalBusiness",
    ...
    "url": "https://www.5280sprinklers.com"
  },
  "areaServed": {
    "@type": "AdministrativeArea",
    "name": "Denver Metro Area"
  },
  "description": "Specialized service to diagnose and repair sprinkler system leaks that cause high water bills. We identify hidden leaks, faulty valves, and other irrigation issues to help homeowners conserve water and save money.",
  "potentialAction": {
    "@type": "ReserveAction",
    "target": {
      "@type": "EntryPoint",
    ...
    "result": {
      "@type": "Reservation",
      "name": "Book High Water Bill Diagnosis"
    }
  }
}
</script>
